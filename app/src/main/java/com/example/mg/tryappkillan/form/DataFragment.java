...
public class DataFragment extends Fragment{ // TODO - CLICK  implements View.OnClickListener {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
     ...
     /*   try {
            int activity = getActivity().getIntent().getExtras().getInt("nameOfActivity");

            Log.e("NameOfActivity",String.valueOf(activity));

            if (activity == 1) {
                LinearLayout linearLayout = (LinearLayout) getView().findViewById(R.id.addContent);
                LayoutInflater inflat = (LayoutInflater) getActivity().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                View itemBox = inflat.inflate(R.layout.row_of_getdistance, (ViewGroup) getView(), false);
